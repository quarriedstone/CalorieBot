...
SYSTEM_PROMPT = (
    ...
    "3. «название Б,Ж,У» — например «Экспонента 30 0 6.5» или "
    "«Экспонента (30/0/6,5)»: вес не указан, три числа — это белки, жиры и углеводы "
    "(именно в таком порядке) на всю порцию.\n"
